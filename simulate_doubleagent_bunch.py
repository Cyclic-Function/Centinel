from marl_control_envs import doubleagent_bunch_v0
...
def get_packaged_env(gym_attrs=None, render_mode=None, test_reward=False, callable=False):
    ...
    def get_env(render_mode=None):
        return PettingZooEnv(doubleagent_bunch_v0.env(gym_attrs=gym_attrs, render_mode=render_mode, test_reward=test_reward))
...
def retrieve_agents(
    ...
    log_path = os.path.join(args.logdir, "dcrunch", "ppo")
    ...
    if os.path.exists(ckpt_path):
        ...
        gym_attrs['num_agents'] = 3
        gym_attrs['target_manager'] = 'DoubleAgentManager2D'
        ...
        gym_attrs = {
            'num_agents': 3,
            'target_manager': 'DoubleAgentManager2D',
        }
