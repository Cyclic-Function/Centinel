from marl_control_envs import bunch_history_v0
...
def get_packaged_env(gym_attrs=None, render_mode=None, test_reward=False, callable=False):
    ...
    def get_env(render_mode=None):
        return PettingZooEnv(bunch_history_v0.env(gym_attrs=gym_attrs, render_mode=render_mode, test_reward=test_reward))
...
def retrieve_agents(
    ...
    log_path = os.path.join(args.logdir, "crunch", "ppo")
